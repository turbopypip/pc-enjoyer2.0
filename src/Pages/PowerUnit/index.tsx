  ...
  return (
    <div>
      ...
      <p>
        ...
        Блок питания (БП) – параллелепипед, на одной из граней которого есть
        отверстия для отверстия для входа воздуха, а на другой – для выхода.
      </p>
      <p>
        Также, на одной из граней расположен разъём для подключения блока
        питания к розетке. Из противоположной грани блока выходят провода,
        питающие компоненты системы.
      </p>
      ...
      <p>
        ...
        полу модульные – лишь некоторые провода, от стандартного блока
      ...
      <p>
        ...
        компонента системы используют наибольшее количество мощности блока.
      </p>
      ...
      <p>
        ...
        максимальная мощность не превышает 350 ватт, однако для миниатюрного
      ...
      <p>
        ...
        сказать сколько пин имеет разъём.
      </p>
      <p>
        Кабели питания MOLEX используются для питания некоторых вентиляторов
        напрямую, а также питания разветвителей для нескольких вентиляторов с
        другим – 4-ёх или 3-ёх пиновым разъёмом. 3-ёх пиновый разъём для питания
        вентилятора совместим с 4-ёх пиновой компоновкой разъёма кабеля самого
        вентилятора, но не наоборот.
      </p>
      <p>
        Кабели питания SATA питают жёсткие диски и SSD-накопители,
        подсоединяемые к материнской плате через кабель SATA-SATA.
      </p>
      <p>
        Кабели питания PCI-E (видеокарты) тоже имеют пиновую структуру, как и
        процессорные кабели. Количество пин блока питания и видеокарты должны
        строго совпадать, поскольку в случае избыточности и не модульности
        коннектора, вы физически не сможете оставить часть ненужных коннекторов
        не подключёнными, чего нельзя сказать про кабели питания процессора.
      </p>
      <p>
        ...
        плате (чаще всего над сокетом процессора).
      </p>
      ...
      <p>
        Если вы планируете будущее улучшение компонентов системы, то лучше всего
        если вы посчитаете мощность для предполагаемого апгрейда или прибавите к
        мощности БП для текущей сборки 100-150 ватт. При конечном выборе блока
        всегда смотрите именно на мощность по 12-ти вольтовой линии, а не по
        номинальной.
      </p>
      <p>
      ...
      <p>
        ...
        технических характеристиках блока или на коробке от него. Чаще всего она
        похожа на представленную на схеме. Соответственно, ваш блок будет
      ...
      <p>
        ...
        также скорость возрастания КПД при увеличении нагрузки.
      </p>
      <p>
      ...
      <p>
        5. Воспользуйтесь нашим калькулятором для расчета мощности блока питания для вашей сборки.
      </p>
