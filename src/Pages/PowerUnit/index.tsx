...
const PowerUnit = () => {
  return (
    <div className="PageContainer">
      ...
      <h2 className="contentParagraph" id="powerUnitDescription">Описание</h2>
      <p>
      ...
      <h2 className="contentParagraph" id="powerUnitForm-Factors">Форм-факторы БП</h2>
      <p>
      ...
      <h2 className="contentParagraph" id="powerUnitConnectors">Питающие разъёмы БП</h2>
      <p>
      ...
      <h2 className="contentParagraph" id="powerUnitCountOfPower">Мощность блока питания</h2>
      <p>
      ...
      <h2 className="contentParagraph" id="powerUnitNoiseLevel">Уровень шума и сертификация Lambda</h2>
      <p>
        <img src={MoneyIcon} width="20" height="20" />Таблица соответствия уровню сертификата шуму:
      </p>
      <p>
        <img src={Photo5} className="powerUnitPhoto5"/>
      </p>

      <h2 className="contentParagraph" id="powerUnitCertification">Сертификация 80 PLUS</h2>
      <p>
        <img src={MoneyIcon} width="20" height="20" />Уровни сертификата 80 PLUS показывает максимальное значение КПД блока, а также скорость возрастания КПД при увеличении нагрузки.
      </p>
      <p>
      ...
      <h2 className="contentParagraph" id="powerUnitSelectionAlgorithm">Алгоритм выбора БП</h2>
      <p>
        <img src={MoneyIcon} width="20" height="20" />1. Выберите подходящую мощность БП при помощи калькулятора с учётом предполагаемого обновления комплектующих и считая мощность именно по 12-ти вольтовой линии.
      </p>
      <p>
      ...
      <p>
        ...
        <a href="https://cutt.ly/ZPICOB6" target="_blank" className="linkToTheOtherWebsite">
          <svg className="linkIcon" viewBox="0 0 16 16" version="1.1" width="14" height="14"
               aria-hidden="true">
            <path fill-rule="evenodd"
                  d="M7.775 3.275a.75.75 0 001.06 1.06l1.25-1.25a2 2 0 112.83 2.83l-2.5 2.5a2 2 0 01-2.83 0 .75.75 0 00-1.06 1.06 3.5 3.5 0 004.95 0l2.5-2.5a3.5 3.5 0 00-4.95-4.95l-1.25 1.25zm-4.69 9.64a2 2 0 010-2.83l2.5-2.5a2 2 0 012.83 0 .75.75 0 001.06-1.06 3.5 3.5 0 00-4.95 0l-2.5 2.5a3.5 3.5 0 004.95 4.95l1.25-1.25a.75.75 0 00-1.06-1.06l-1.25 1.25a2 2 0 01-2.83 0z"></path>
          </svg>ссылке</a>
        {". Рекомендуем покупать блоки с оценкой в таблице от 7 и выше. Однако, стоит помнить что далеко не все БП были протестированы для создания этой таблицы. Также, отношение цены к качеству товара в таблице не учитывается."}
      </p>
