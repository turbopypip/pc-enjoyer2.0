...
const OpMemory = () => {
  return (
    <div>
      ...
      <ContentAnchorsList />
      <h2 className="contentParagraph" id="opMemoryDescription">Описание</h2>
      <p>
      ...
      <h2 className="contentParagraph" id="opMemoryTypes">Типы памяти</h2>
      <p>
      ...
      <p>
        Ранее выпускались материнские платы с поддержкой нескольких типов, поэтому появление таковых на рынке не исключено.
      </p>
      <p>
        <img src={PhysicsIcon} width="20" height="20" />Поколения оперативной памяти отличаются физически, а значит и разъёмы материнской платы изменяются в зависимости от поддерживаемого типа.
      </p>
      <p>
        <img src={Photo2} className="opMemoryPhoto2"/>
      </p>

      <h2 className="contentParagraph" id="opMemoryVolume">Объём оперативной памяти</h2>
      <p>
        <img src={MoneyIcon} width="20" height="20" />Для офисной работы хватит 4 ГБ, но, если вы работаете с огромным количеством данных одновременно, лучше докупить ещё один такой модуль.
      </p>
      <p>
      ...
      <h2 className="contentParagraph" id="opMemoryFrequency">Эффективная частота</h2>
      <p>
        Пример эффективной частоты оперативной памяти выглядит следующим образом: 3200 MHZ (мегагерц) MT/S (миллионов передач данных в секунду) = 3 200 000 000 тактов/сек.
      </p>
      <p>
        <img src={PhysicsIcon} width="20" height="20" />Реальная частота памяти — это число электрических импульсов или же тактов в секунду, а эффективная частота — это реальная частота, умноженная на число бит, передаваемых за один рабочий такт. Поэтому измерять эффективную частоту в мегагерцах не совсем корректно, и производители оперативной памяти делают это в качестве допущения, для удобства покупателя.
      </p>
      <p>
      ...
      <p>
        <img src={PhysicsIcon} width="20" height="20" />По частоте в физическом смысле оперативная память отличается количеством электрических сигналов, которые посылаются другими компонентами компьютера в течение одного цикла тактов. Отличить память по данному признаку можно, воспользовавшись схемой:
      </p>
      <p>
        <img src={Photo3} className="opMemoryPhoto3"/>
      </p>

      <h3 className="contentParagraphTopics">В условиях равных таймингов (в наносекундах):</h3>
      <p>
      ...
      <p>
        Для офисных задач разгон не имеет смысла.
      </p>
      <p>
        <img src={PhysicsIcon} width="20" height="20" />По типу памяти в физическом смысле оперативная память отличается количеством электрических сигналов, которые посылаются другими компонентами компьютера в течение одного цикла тактов.
      </p>

      <h2 className="contentParagraph" id="opMemoryXMPAndDOCP">XMP и DOCP профили</h2>
      <p>
        <img src={MoneyIcon} width="20" height="20" />Настройки XMP (Xtreme Memory Profile) нужны для того чтобы увеличить эффективность работы памяти без особого вмешательства пользователя.
      </p>
      <p>
      ...
      <p>
        C течением времени пользователь более вероятно захочет поменять память ввиду того, что будет считать её недостаточно эффективной для своих запросов, однако к тому моменту она ни разу не работала “на максимум”. Всё вышеперечисленное актуально и для DOCP (Direct Overclock Profile).
      </p>
      <p>
        На планках памяти устанавливается микросхема с информацией. Эта информация – набор настроек частоты, напряжения и таймингов памяти, которые пользователь может активировать двумя нажатиями. Таких наборов информации может быть несколько.
      </p>
      <p>
        <img src={PhysicsIcon} width="20" height="20" />В BIOS кнопки для включения этих профилей могут выглядеть следующим образом:
      </p>
      <p>
        <img src={Photo4} className="opMemoryPhoto4"/>
      </p>
      <p>
        XMP профиль в BIOS материнской платы ASUS
      </p>
      <p>
      ...
      <p>
        <img src={MoneyIcon} width="20" height="20" />Тайминги – задержки между осуществлениями функциональных операций оперативной памяти, выражаемые в последовательности значений в тактах, разделённых тире с приставкой CL или, реже, одним значением с приставкой CL
      </p>
      <p>
      ...
      <p>
        <img src={PhysicsIcon} width="20" height="20" />Каждый модуль памяти состоит из чипов памяти – чёрных квадратов, выступающих из корпуса модуля. Чипы памяти имеют структуру в виде ячеек для хранения заряда. Таким образом выглядит упрощённая схема цикла работы памяти:
      </p>
      <p>
      ...
      <p>
        <img src={MoneyIcon} width="20" height="20" />Ещё один фактор, влияющий на работу оперативной памяти – напряжение. Повышение напряжения в BIOS позволит вам более эффективно разогнать память.
      </p>
      <p>
      ...
      <p>
        <img src={PhysicsIcon} width="20" height="20" />От напряжения зависит скорость зарядки всех элементов, работа которых зависит от заряда (строк RAS во время Precharge, время зарядки ячейки буфера (tCL) и т.д).
      </p>
      ...
      <h2 className="contentParagraph" id="opMemoryOutsideFactors">Факторы, влияющие на характеристики памяти</h2>
      <p>
        <img src={MoneyIcon} width="20" height="20" />Существует пять факторов, влияющих на характеристики оперативной памяти – три фактора технологии производства и сырья и два фактора влияния остальных комплектующих ПК.
      </p>
      <p>
      ...
      <h3 className="contentParagraphTopics">Факторы технологии производства и сырья</h3>
      <p>
      ...
      <p>
        Определить ранг памяти можно почти достоверно при помощи QVL списка или при наличии указания ранга у некоторых производителей, или по объёму оперативной памяти – память второго ранга встречается почти всегда в 16-ти гигабайтном и более исполнении, а первого – в объёме менее 16-ти гигабайт.
      </p>
      <p>
        <img src={PhysicsIcon} width="20" height="20" />Ранг памяти – то, каким образом чипы памяти спроектированы на печатной плате и ширина шины этих чипов. Ширина шины – количество бит информации, передаваемой в такт.
      </p>
      <p>
        Одноранговая память – память с шириной шины в 64 бит, которая состоит из чётного количество чипов с разной собственной шириной шины.
      </p>
      <p>
        При увеличении ранга памяти по одному растёт количество 64-ёх битных областей.
      </p>
      ...
      <p>
        <img src={PhysicsIcon} width="20" height="20" />Во втором случае указывают по сути количество сторон, на которых расположены чипы памяти.
      </p>
      <p>
      ...
      <p>
        <img src={PhysicsIcon} width="20" height="20" />На то, как установить модули памяти для максимального быстродействия (задействования максимального количества каналов) и влияют топология и количество каналов.
      </p>
      <p>
      ...
      <p>
        <img src={PhysicsIcon} width="20" height="20" />На данной схеме вы можете увидеть принципиальное различие топологий:
      </p>
      <p>
      ...
      <h2 className="contentParagraph" id="opMemorySelectionAlgorithm">Алгоритм выбора оперативной памяти</h2>

      <h3 className="contentParagraphTopics">1.Если материнская плата не поддерживает разгон оперативной памяти</h3>
      <p>
      ...
      <h3 className="contentParagraphTopics">2.Если материнская плата поддерживает разгон оперативной памяти, но вы не собираетесь разгонять</h3>
      <p>
        1. Удостоверьтесь что выбранная материнская плата поддерживает выбранный тип оперативной памяти.
      </p>
      <p>
      ...
      <h3 className="contentParagraphTopics">3.Если материнская плата поддерживает разгон оперативной памяти, и вы собираетесь разгонять</h3>
      <p>
        1. Удостоверьтесь что выбранная материнская плата поддерживает выбранный тип оперативной памяти.
      </p>
      <p>
