  ...
  return (
    <div className="PageContainer">
      ...
      <p>
        ...
        исполнении, то плата скорее всего имеет Т-топологию, а если в 2-ух модульном и количество разъёмов на плате превышает 2, то Цепь Дейзи.
      </p>
      <br />
      <p>
      ...
      <p>
        Степпинг процессора, который Вы найдёте введя в любую поисковую
        строку код производителя или номер партии (располагаются на странице в интернет-магазине), Вы должны сравнить дату выхода
        процессора с таким степпингом и дату выхода материнской платы.
      </p>
      <p>
