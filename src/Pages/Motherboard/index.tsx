  ...
  return (
    <div className="PageContainer">
      ...
      <p>
        ...
        из которой выпирают множество разъёмов, иногда радиаторы.
      </p>
      <p>
        На плате располагаются и другие электрические элементы. В её левом
        верхнем углу или в центре располагается сокет для процессора.
      </p>
      <p>
        Слева от него – входы для периферии, сети. В нижней центральной части –
      ...
      <p>
        Этот параметр напрямую влияет, как на внешний вид в целом, собираемого
        системного блока, так и на вместительность. В контексте выбора
        материнской платы также стоит помнить, что от размера платы зависит
        тепловыделение и количество различных разъёмов на плате. Как правило, в
        современных ПК в большинстве используются платы размера ATX и Micro ATX.
      </p>
      <p>
      ...
      <p>
        ...
        процессора, они не будут иметь совместимости со старта.
      </p>
      <p>
        Ревизия процессора характеризуется степпингом. Для того чтобы
        совместимость появилась вы должны будете обновить ПО BIOS вашей
        материнской платы. Сделать это можно несколькими способами:
      </p>
      <p>
      ...
      <p>
        У ASRock версия BIOS указывается на микросхеме самого BIOS. Выглядит это
        следующим образом:
      </p>
      <p>
      ...
      <p>
        ...
        цифробуквенном виде в названии продукта. Для покупателя основных отличия
        различных чипсетов три:
      </p>
      <p>1. Количество разъёмов материнской платы</p>
      <p>2. Возможность поддержки SLI/Crossfire режимов работы видеокарт.</p>
      <p>3. Возможность разгона процессора и/или оперативной памяти.</p>
      <p>
      ...
      <p>
        ...
        поддержки в спецификации той или иной функции.
      </p>
      ...
      <p>
        ...
        режима крайне сомнительно экономически.
      </p>
      <p>
        Если вы нацелены на использование одного из этих режимов, учтите, что во
        время использования этих технологий вы можете наблюдать различные
        графические ошибки во время исполнения различных задач.
      </p>
      <p>
        Из-за этого мы рекомендуем вам смотреть в сети тесты вашей конкретной
        связки видеокарт и технологии в ваших задачах.
      </p>
      ...
      <p>
        ...
        оперативная память. Наличие такой поддержки позволяет изменять частоту и
      ...
      <p>
        ...
        платы такой поддержки имеют жёсткое ограничение по максимальной частоте
        оперативной памяти.
      </p>
      <p>Эти ограничения также прописаны в характеристиках материнских плат.</p>
      <p>
        ...
        производителя чипсета, который указывается в технических характеристиках
        платы.
      </p>
