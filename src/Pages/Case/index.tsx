...
const Case = () => {
  return (
    <div className="PageContainer">
      ...
      <h2 className="contentParagraph" id="caseDescription">Описание</h2>
      <p>
        <img src={MoneyIcon} width="20" height="20" />После выбора всех комплектующих компьютера предстаёт задача подобрать под них корпус. Корпус – внешняя оболочка компьютера, защищающая его от пыли и неэффективного распределения воздушных потоков.
      </p>
      <p>
        Корпусы могут быть самых разных форм, но у все корпуса стандартизированы под один из форм-факторов.
      </p>

      <h2 className="contentParagraph" id="caseForms">Форм-фактор корпуса</h2>
      <p>
        <img src={MoneyIcon} width="20" height="20" />Основной характеристикой коруса является его размер. Все корпуса классифицируются по размеру поддерживаемой материнской платы на:
      </p>
      <p>
        Mini-ITX (170х170 мм) Micro-ATX (244х244 мм) ATX (305x244 мм) E-ATX (305х330 мм) XL-ATX (345х262 мм)
      </p>
      <p>
      ...
      <p>
        Желательно заранее спланировать порядок установки и расположение проводов, ведь при неправильном подходе придётся несколько раз устанавливать одни и те же комплектующие для доступа к установке других, кабель-менеджмент также позволит избежать трудностей при сборке ПК, его обновлении, и устранении неполадок. Также нужно учитывать максимальную длину видеокарты и максимальную высоту охлаждения центрального процессора.
      </p>

      <h2 className="contentParagraph" id="caseCooling">Охлаждение и организация воздушных потоков</h2>
      <p>
        <img src={MoneyIcon} width="20" height="20" />В корпусе может располагаться разное количество системных вентиляторов, как заранее установленных, так и требующих Вашего вмешательства в установке.
      </p>
      <p>
        В системах воздушного охлаждения очевидно, что чем больше вентиляторов, тем лучше, однако не менее важна организация движения потоков воздуха внутри корпуса:
      </p>
      <p>
        1. Холодный воздух поступает снизу, горячий выходит сверху
      </p>
      <p>
        2. Также не стоить ставить все вентиляторы только на вдув или же только на выдув
      </p>
      <p>
      ...
      <p>
        <img src={PhysicsIcon} width="20" height="20" />1. При такой схеме избегается смешивание холодных и горячих потоков вне корпуса, так как горячий воздух легче холодного и стремится вверх, а холодный стремится вниз.
      </p>
      <p>
        2. Если все вентиляторы ставить на вдув, то такая система повысит давление внутри ПК, что эффективнее защитит его от пыли, но потребует большей работы от вентиляторов для преодоления большего сопротивления воздуха, из-за чего те будут больше шуметь и быстрее изнашиваться.
      </p>
      <p>
        3. Если все вентиляторы ставить на выдув, то такая система понизит давление внутри ПК, из-за чего пыль будет стремиться внутрь корпуса
      </p>
      <p>
      ...
      <h2 className="contentParagraph" id="caseConvenience">Дополнительные удобства</h2>
      <p>
        <img src={MoneyIcon} width="20" height="20" />После рассмотрения способа охлаждения переходим к удобству корпуса.
      </p>
      <p>
      ...
      <p>
        7. Наличие открывающейся боковой стенки с ручкой.
      </p>
      <p>
