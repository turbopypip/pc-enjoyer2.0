  ...
  return (
    <div>
      ...
      <p>
        ...
        После выбора всех комплектующих компьютера необходимо выбрать
        под них корпус. Корпус – внешняя оболочка компьютера, защищающая его от
        пыли и неэффективного распределения воздушных потоков.
      </p>
      <p>
        Корпусы могут быть самых разных форм, но все они стандартизированы
        под один из форм-факторов.
      </p>
      ...
      <p>
        В корпус с поддержкой больших форм-факторов
        почти всегда можно вставить материнскую плату меньшего размера, но не
        наоборот.
      </p>
      <p>
      ...
      <p>
        В большинстве современных ПК используются платы размера
        ATX и Micro ATX. Данные форм-факторы подойдут для сборки ПК любой
        конфигурации, начиная от офисного варианта, заканчивая игровым или
        рабочим компьютером.
      </p>
      <p>
        Желательно заранее спланировать порядок установки и расположение
        проводов для максимальной скорости сборки ПК.
        Кабель-менеджмент позволит избежать трудностей при сборке ПК, его
        обновлении, и устранении неполадок. Нужно учитывать максимальную
        длину видеокарты и максимальную высоту башни охлаждения центрального
        процессора.
      </p>
      ...
      <p>
        В системах воздушного охлаждения чем больше вентиляторов,
        тем лучше, однако не менее важна организация движения потоков воздуха
        внутри корпуса:
      </p>
      <p>Холодный воздух поступает снизу, горячий выходит сверху.</p>
      <p>
        Не стоить ставить все вентиляторы только на вдув или же только
        на выдув.
      </p>
      ...
      <p>
        ...
        При такой схеме избегается смешивание холодных и горячих потоков вне
        корпуса, так как горячий воздух легче холодного и стремится вверх, а
        холодный стремится вниз.
      </p>
      <p>
        Если все вентиляторы ставить на вдув, это повысит
        давление внутри ПК, что эффективнее защитит его от пыли, но потребует
        большей работы от вентиляторов для преодоления сопротивления
        воздуха, из-за чего те будут больше шуметь и быстрее изнашиваться.
      </p>
      <p>
        Если все вентиляторы ставить на выдув, давление внутри ПК понизится, из-за чего пыль будет стремиться внутрь корпуса.
      </p>
      <p>
      ...
      <p>
        ...
        нравится такой вариант, но шум нужно снизить, помогут
        силиконовые гвозди, ведь они уменьшают вибрации от
        вентиляторов.
      </p>
      <p>
        Вместо воздушной системы охлаждения в корпусе может быть предустановлена система водяного охлаждения.
      </p>
